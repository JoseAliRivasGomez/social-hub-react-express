...
class Server {
    ...
    middlewares() {
        ...
        this.app.use(cors({
            origin: ['https://social-hub-react-express-production.up.railway.app'],
        ...
        callbackURL: `https://social-hub-react-express-production.up.railway.app/api/connections/auth/linkedin/callback`,
        ...
        passport.use(new Strategy({
            ...
            callbackURL: `https://social-hub-react-express-production.up.railway.app/api/connections/auth/twitter/callback`,
